    ...
    return (
        <main className="flex-grow flex flex-col items-center justify-center p-6 text-center">
            ...
            <div className="border border-black p-12 bg-neutral-50 max-w-md">
                ...
                <Link
                    href="/shop"
                    className="block w-full border border-black py-4 bg-black text-white font-mono text-[10px] uppercase tracking-widest hover:bg-white hover:text-black transition-colors text-center"
                >
