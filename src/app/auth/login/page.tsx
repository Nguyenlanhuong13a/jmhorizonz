        ...
        <main className="fixed inset-0 h-screen w-screen flex items-center justify-center p-6 bg-[#000] overflow-hidden">
            ...
            >
                ...
                <motion.button
                    ...
                    className="w-full py-4 border border-white border-opacity-30 bg-transparent text-white font-mono text-[12px] uppercase tracking-[0.2em] hover:border-opacity-100 transition-all flex items-center justify-center gap-3"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
